...
Values can be translated between nodes in the graph that are connected following the edges and adjusting the value according to the translation rule associated with the edge.
